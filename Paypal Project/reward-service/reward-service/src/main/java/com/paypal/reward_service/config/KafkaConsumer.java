...
public ConsumerFactory<String, Transaction> consumerfactory(){
    JacksonJsonDeserializer<Transaction> deserialize=new JacksonJsonDeserializer<>(Transaction.class);
    deserialize.setRemoveTypeHeaders((false));
    deserialize.setUseTypeMapperForKey((true));
    deserialize.addTrustedPackages("com.paypal.transaction-services,entity");
